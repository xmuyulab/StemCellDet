...
class CascadeRoIHeadOrganBase(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeRoIHeadOrganBase, self).__init__(bbox_roi_extractor=bbox_roi_extractor,
                                              bbox_head=bbox_head,
    ...
    def init_bbox_head(self, bbox_roi_extractor, bbox_head):
        ...
        self.project_for_multi = nn.ModuleList() # L10 add
        self.project_for_cls = nn.ModuleList() # L10 add
        ...
        for roi_extractor, head in zip(bbox_roi_extractor, bbox_head):
            ...
            self.project_for_multi.append(nn.Linear(512, 512))
            self.project_for_cls.append(nn.Linear(512, 3 + 1))
            if bbox_head[0].ensemble:
